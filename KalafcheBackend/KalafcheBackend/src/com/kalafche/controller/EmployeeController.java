...
public class EmployeeController {
	...
	@RequestMapping(method = { org.springframework.web.bind.annotation.RequestMethod.PUT }, params = { "userId" })
	public void deactivateAccount(@RequestParam(value = "userId") int userId) {
